# Content Sources for Nick's Personal Blog

## 🎙️ Podcasts (Daily Crawl)
...
| Source | URL | Frequency | Notes |
|--------|-----|-----------|-------|
| **Huberman Lab** | hubermanlab.com | Weekly | Already have 1 episode |
| **FoundMyFitness** | @drpaultoconi | Weekly | Rhonda Patrick - science of health |

### Productivity & Learning
| Source | URL | Frequency | Notes |
|--------|-----|-----------|-------|
| **The Knowledge Project** | @shaneaparrish | Weekly | Mental models, decision making |
| **Deep Questions** | @nataliejobq | Daily | Cal Newport - deep work |

---

## 📺 YouTube Channels (Daily Crawl)
...
| Channel | URL | Frequency | Notes |
|---------|-----|-----------|-------|
| **@JeffNippard** | YouTube | Weekly | Science-based fitness |
| **@GeoffreyVeritySchofield** | YouTube | Weekly | Evidence-based training |
| **@StrongerByScience** | YouTube | Weekly | Science of strength |
...
|---------|--------|-------|
| **Andrew Huberman** | @hubermanlab | Neuroscience tips |
| **Lex Fridman** | @lexfridman | AI & long-form |
| **David Perell** | @davidperell | Writing & online business |
| **Natasha Jones** | @nataliejobq | Deep work |
| **Gwern** | @gwern | AI & tech |
| **Yann LeCun** | @ylecun | AI research |
| **Sam Altman** | @sama | OpenAI |
| **Arvind Narayanan** | @random_walker | AI & tech criticism |
...
For Nick's training insights, I'll create a structured format:
...
### Sources for Training Content
- **Podcasts**: Huberman Lab, FoundMyFitness, Jeff Nippard
- **YouTube**: StrongerByScience, Geoffrey Verity Schofield
- **Apps**: TrainingPeaks, Zwift, WHOOP data

---

## 📅 Daily Crawl Priority

1. **Morning**: FPL channels (for daily digest)
2. **Evening**: AI news (Limitless, The AI Edge)
3. **Weekly**: Long-form podcasts (Huberman, Lex Fridman)
4. **Weekly**: Training podcasts (Jeff Nippard)
